        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    todo = new todo_1.default({ userId: userId, text: text });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, todo_1.default.deleteOne({ userId: userId, text: text }).exec()];
                case 1:
                    result = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, todo_1.default.find({ userId: userId }).exec()];
                case 1:
                    todos = _a.sent();
